...
void main() {
    ...
    test('fails when password is shorter than minimum length', () {
      var validation = PasswordValidationSupport('Bh@12')
          .minLength(8)
          .validate();
    ...
    test('fails when password is greater than maximum length', () {
      var validation = PasswordValidationSupport('BharatPassword@123')
          .maxLength(15)
          .validate();
    ...
    test('fails when password has no number', () {
      var validation = PasswordValidationSupport('Bharat@')
          .hasNumber()
          .validate();
    ...
    test('fails when password has no special character', () {
      var validation = PasswordValidationSupport('Bharat123')
          .hasSpecialCharacter()
          .validate();
    ...
    test('uses custom message for minLength', () {
      var validation = PasswordValidationSupport('Bh@1')
          .minLength(8, message: 'Minimum 8 chars required')
          .validate();
    ...
    test('uses custom message for uppercase validation', () {
      var validation = PasswordValidationSupport('bharat@123')
          .hasUppercase(message: 'Add one capital letter')
          .validate();
    ...
    test('uses custom message for lowercase validation', () {
      var validation = PasswordValidationSupport('BHARAT@123')
          .hasLowercase(message: 'Add one small letter')
          .validate();
    ...
    test('uses custom message for number validation', () {
      var validation = PasswordValidationSupport('Bharat@')
          .hasNumber(message: 'Add one digit')
          .validate();
    ...
    test('uses custom message for special character validation', () {
      var validation = PasswordValidationSupport('Bharat123')
          .hasSpecialCharacter(message: 'Add one special symbol')
          .validate();
